...
class _SenderSectionState extends State<SenderSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text("Sender Mode", style: TextStyle(color: Colors.white, fontSize: 20.sp, fontWeight: FontWeight.bold)),
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      helperStyle: TextStyle(color: Colors.white60, fontStyle: FontStyle.italic, fontSize: 12.sp),
  ...
  Widget _btn(BuildContext context, IconData icon, String text, bool isFolder, TransferState state) {
    return ElevatedButton.icon(
      ...
      label: Text(text, style: TextStyle(color: Colors.white, fontSize: 14.sp)),
