    ...
    return BlocBuilder<TransferCubit, TransferState>(
      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          child: Column(
            children: [
              Text(model.status, style: TextStyle(color: Colors.blueAccent, fontSize: 18.sp, fontWeight: FontWeight.bold)),
              SizedBox(height: 15.h),
              Text("${model.speed.toStringAsFixed(1)} MB/s",
                  style: TextStyle(color: Colors.white, fontSize: 50.sp, fontWeight: FontWeight.bold)),
